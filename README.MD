...
```bash
usage: main.py [-h] [--action ACTION] [--model MODEL] [--id ID] [--name NAME] [--subject SUBJECT] [--value VALUE] [--list LIST]
...
options:
  ...
  --action ACTION, -a ACTION
                        Commands: create, update, get, remove
  --model MODEL, -m MODEL
  ...
  --value VALUE, -v VALUE
                        Value of the object
  --list LIST, -l LIST  List of the objects
```
